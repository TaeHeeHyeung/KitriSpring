...
$(document).ready(function() {
	console.log('list.jsp bcode: ${bcode}');
	console.log('list.jsp pg: ${pg}');
	console.log('list.jsp key: ${key}');
	console.log('list.jsp word: ${word}');
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
		...
		<td nowrap>
			...
			<span id="sear1"> 
				<input type="text" name="query" id= "sword" size="22" class="inp" style="margin-top: -19px"; > 
			</span> 
